...
export const metadata: Metadata = {
  title: 'Аліна Татур — Юрист за кордоном | Прага, Чехія',
  description: 'Юридична допомога та оформлення документів у Чехії. Візи, робочі карти, паспорти, працевлаштування. Аліна Татур — практикуючий юрист у Празі.',
  keywords: 'юрист Прага, документи Чехія, робоча карта, віза Чехія, закордонний паспорт, працевлаштування Чехія',
  openGraph: {
    title: 'Аліна Татур — Юрист за кордоном',
