...
import { Phone, Send, CheckCircle2, Facebook, Mail, Instagram } from 'lucide-react'
...
export default function Contact() {
  ...
  const contacts = [
    ...
    },
    {
      ...
      label: 'Email',
      value: 'uristkonsultant26@gmail.com',
      href: 'mailto:uristkonsultant26@gmail.com',
    },
    {
      icon: <Instagram size={20} className="text-gold-500" />,
      label: 'Instagram',
      value: '@alinatataruiurist',
      href: 'https://www.instagram.com/alinatataruiurist',
    },
  ]
          ...
          >
            ...
            <div className="relative w-full aspect-[16/9] rounded-2xl overflow-hidden hidden lg:block">
              ...
              <div className="absolute bottom-0 left-0 right-0 p-6">
                ...
                <p className="text-gold-400 text-sm mt-1">Юрист без кордонів</p>
              </div>
            </div>
