...
export default function Footer() {
  ...
  return (
    <footer className="bg-navy-950 border-t border-gold-500/10 py-10">
      <div className="max-w-7xl mx-auto px-6 flex flex-col items-center gap-6 md:flex-row md:justify-between md:gap-4">
        {/* Logo */}
        ...
        <div className="flex flex-wrap justify-center gap-x-4 gap-y-2">
          ...
          <a href="mailto:uristkonsultant26@gmail.com" className="text-white/30 hover:text-gold-400 text-sm transition-colors whitespace-nowrap">
