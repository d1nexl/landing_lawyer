    ...
    <footer className="bg-navy-950 border-t border-gold-500/10 py-10">
      <div className="max-w-7xl mx-auto px-6 flex flex-col md:flex-row items-center justify-between gap-4">
        <div className="flex items-center gap-3">
          ...
          <div>
            <p className="font-display text-sm font-semibold text-white">Аліна Татур</p>
            <p className="text-[10px] text-gold-500/60 tracking-widest uppercase">Юрист за кордоном</p>
          </div>
        </div>
        ...
        <div className="flex gap-4">
          ...
          <a href="viber://chat?number=%2B380979217886" className="text-white/30 hover:text-gold-400 text-xs transition-colors">
            Viber
          </a>
          <a href="tel:+420723720172" className="text-white/30 hover:text-gold-400 text-xs transition-colors">
            +420 723 720 172
          </a>
        </div>
      </div>
